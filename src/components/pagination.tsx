...
export function Pagination({
  ...
  return (
    <ul className="flex justify-end items-center gap-3 text-gray-900 my-4">
      <li className="flex gap-1">
        {currentPage > 1 && (
          <button
            type="button"
            className="flex size-8 p-1 w-min items-center rounded border border-gray-200 transition-colors cursor-pointer hover:bg-gray-50 rtl:rotate-180 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <li className="flex gap-1">
        ...
        {currentPage < numberPages && (
          <button
            ...
            className="flex size-8 p-1 w-min items-center rounded border border-gray-200 transition-colors cursor-pointer hover:bg-gray-50 rtl:rotate-180 disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label="Previous page"
            title="Next to last page"
            onClick={() => changePage(numberPages)}
          >
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
